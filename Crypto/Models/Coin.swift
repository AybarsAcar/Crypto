...
struct Coin: Identifiable, Codable {
  ...
  // we dont get this from the API
  // so it would be better to make this struct a DTO then map it to a model we have in our application
  let currentHoldings: Double?
  
  // required because i.e json response has current_price but the struct has currentPrice property
  ...
  var totalCurrentHoldingsValue: Double {
